...
{    
    ...
    public static class PCANBasic
    {
        ...
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_Initialize")]
        ...
        /// <param name="Channel">The handle of a PCAN Channel</param>
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_Uninitialize")]
        ...
        /// <param name="Channel">The handle of a PCAN Channel</param>
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_Reset")]
        ...
        /// <param name="Channel">The handle of a PCAN Channel</param>
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_GetStatus")]
        ...
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_Read")]
        ...
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_Write")]
        ...
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_FilterMessages")]
        ...
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_GetValue")]
        ...
        /// <param name="BufferLength">Size in bytes of the buffer</param>
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_SetValue")]
        ...
        /// <returns>A TPCANStatus error code</returns>
        [DllImport(@"CANDevicesLibrarys\PCANBasic.dll", EntryPoint = "CAN_GetErrorText")]
